...
export function TowersPage() {
  ...
  const columns: DataTableColumn<any>[] = [
    ...
    { key: "foundation_type_code", header: "نوع دکل", sortable: true, filterable: true, align: "right" },
  ...
  return (
    <div className="space-y-2">
      ...
      <DataTable
        ...
        columns={columns}
        loading={loading}
        searchKeys={["tower_code", "line_code", "line_name", "tower_structure", "foundation_type", "line_supervisor", "voltage_kv"]}
        title="دکل‌ها"
