...
interface FormData {
  ...
  tower_structure: string; foundation_type_code: string; foundation_type: string;
...
const empty: FormData = {
  ...
  tower_structure: "مشبک فلزی", foundation_type_code: "", foundation_type: "",
    ...
    if (open) {
      ...
      if (sourceRow) {
        ...
        setForm({
          ...
          tower_structure: s(sourceRow.tower_structure) || "مشبک فلزی",
          foundation_type_code: s(sourceRow.foundation_type_code),
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: Record<string, unknown> = {
        ...
        foundation_type_code: str(form.foundation_type_code),
        ...
        <form onSubmit={submit} className="space-y-5">
          ...
          <div className="space-y-3 p-4 bg-white dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <Field label="سرپرست خط (از پرسنل)">
                <SearchableSelect
          ...
          <div className="space-y-3 p-4 bg-white dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Field label="ساختار دکل">
                <Input value={form.tower_structure} onChange={e => set("tower_structure", e.target.value)} className="text-right bg-white" placeholder="مشبک فلزی" />
              </Field>
              <Field label="نوع دکل">
                <Input value={form.foundation_type_code} onChange={e => set("foundation_type_code", e.target.value)} dir="ltr" className="text-left bg-white" placeholder="NN، AN، LT و..." />
              </Field>
