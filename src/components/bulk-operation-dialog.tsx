...
/**
 * بدنهٔ «تأیید/پیشرفت عملیات گروهی» — بدون پوستهٔ Dialog.
 * هم داخل BulkOperationDialog استفاده می‌شود و هم داخل دیالوگ انتخاب مقدار
 * تا جابه‌جایی بین دو مرحله بدون بسته/باز شدن پنجره (بدون فلش نور) انجام شود.
 */
